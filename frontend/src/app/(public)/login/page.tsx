    ...
    try {
      ...
      if (response.data.status) {
        ...
        if (token && user) {
          ...
          console.log("Login successful:", { token, user, role: user.role });
          if (user.role == "admin") {
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
            ...
            <p className="text-gray-600 mb-6">
              Manage your appointments, view medical reports, and stay in
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="text-sm text-blue-700 space-y-1">
                ...
                <p>
                  <strong>Patient:</strong> Any email / Any password
                </p>
                <p>
                  <strong>OTP:</strong> Use any 6-digit number
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex flex-col items-center p-6 bg-blue-50 rounded-lg"
                >
          ...
          <div className="mt-12 max-w-2xl mx-auto p-6 bg-green-50 rounded-lg border border-green-200">
            ...
            <p className="text-sm text-green-700 text-center">
              Your personal health information is protected with bank-level
              encryption and follows strict privacy regulations.
            </p>
          </div>
        </div>
      </section>
